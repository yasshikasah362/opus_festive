...
export default async function Dashboard() {
  ...
  if (!session) {
    return (
      <div
        className="flex items-center justify-center min-h-screen bg-[url('https://www.transparenttextures.com/patterns/flowers.png')] bg-gray-50"
      >
  ...
  return (
    <div
      className="flex items-center justify-center min-h-screen bg-[url('https://www.transparenttextures.com/patterns/flowers.png')] bg-indigo-50"
    >
