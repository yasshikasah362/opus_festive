...
const Gandhijayanti = ({username}) => {
  ...
  <div className="flex flex-1 flex-col sm:flex-row overflow-hidden">
    ...
    <div className="flex flex-col w-full sm:w-[320px] md:w-[360px] lg:w-[400px] xl:w-[440px] overflow-y-auto">
      {/* Mobile: Selected Template on top */}
      {selectedTemplate && (
        <div className="sm:hidden w-full p-2 bg-gray-50 flex justify-center">
          <div className="relative w-full max-w-[95%] h-auto max-h-[40vh] rounded-xl flex items-center justify-center shadow-md overflow-hidden">
            <img
      ...
      {/* Tab Content */}
      <div className="bg-white p-3 sm:p-5 flex flex-col gap-4">
        {/* Templates */}
        {active === "templates" && (
            ...
            {products.map((prod, i) => {
              ...
              return (
                ...
                >
                  ...
                  />
                  <h4 className="font-medium text-xs sm:text-sm text-gray-800 text-center mt-1">
                    {prod.product_name}
                  </h4>
                </div>
              );
    ...
    {/* Right Panel (Desktop Only): Selected Template Preview */}
