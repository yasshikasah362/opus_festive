...
import { Flyer_Prompts, Flyer_Heading } from "./FlyerData"; // <-- import heading data
import productsData from "../../public/products.json";
import Sidebar from "./Sidebar";

export default function Flyer() {
  const [activeTab, setActiveTab] = useState("templates");
  const [activeEdit, setActiveEdit] = useState(null); // <-- new state
    ...
    <div className="h-screen flex flex-col bg-gray-100">
      <div className="flex mt-16">
            ...
            return (
              <button
                ...
                onClick={() => { 
                  ...
                  setActiveEdit(null); // reset edit mode jab tab change ho
                }}
        ...
        <aside className="w-96 p-4 h-160 flex flex-col overflow-y-auto bg-white border-l">
          {activeEdit === "heading" ? (
            <div>
              <h2 className="font-bold mb-2">Choose Heading</h2>
              <select className="w-full border p-2 rounded">
                {Flyer_Heading.map((heading, idx) => (
                  ...
                  Object.entries(selectedTemplate.annotations).map(([key, value]) => {
                    ...
                    return (
                      <button
                        ...
                        onClick={() => setActiveEdit(key)} // <-- set active edit
                      >
